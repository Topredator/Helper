...
@interface TPAnimalIntroduceCell ()
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UILabel *conditionLabel;
@end
@implementation TPAnimalIntroduceCell
- (void)setupSubviews {
...
@implementation TPAnimalIntroduceRow
@dynamic cell;
- (instancetype)init {
    self = [super init];
    if (self) {
        [self setCellClass:TPAnimalIntroduceCell.class];
    }
    return self;
}
...
- (void)setContent:(NSString *)content {
    _content = content;
    if (self.cell) {
        self.cell.conditionLabel.text = content;
    }
}
- (void)tp_tableViewPreparedCell:(TPAnimalIntroduceCell *)cell proxy:(TPTableViewProxy *)proxy indexPath:(NSIndexPath *)indexPath {
    cell.titleLabel.text = self.title;
    cell.conditionLabel.text = self.content;
