...
@interface TPReleaseAdoptInputCell : TPUIBaseTableViewCell

@end

/// 发布领养 带有输入框的单元格
@interface TPReleaseAdoptInputRow : TPTableRow
@property (nonatomic, weak) TPReleaseAdoptInputCell *cell;
