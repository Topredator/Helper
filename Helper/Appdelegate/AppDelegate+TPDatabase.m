...
- (void)tp_initCustomInfo {
    ...
    TPUserModel *customModel = [TPUserModel userAccount:@"15906615096" pwd:@"123456" name:@"HHH" idCard:@"410425199202110037" type:TPUserTypeCustome];
    [TPDBRouter sendTaskMessage:TPUserModuleRegister argument:[customModel tp_modelToJSONObject]];
